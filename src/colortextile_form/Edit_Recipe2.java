 ...
 * @author Eldridge
 */
public class Edit_Recipe2 extends javax.swing.JFrame {
...
//        int y = (int) ((dimension.getHeight() - this.getHeight()) / 2);
    ...
    private void initComponents() {
        ...
        jPanel10.setBounds(370, -40, 0, 40);
    ...
    public void fill_info_from_purchase_id(int purchase_order){
        ...
        try {
            ...
            Logger.getLogger(Edit_Recipe2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edit_Recipe2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Edit_Recipe2().setVisible(true);
            }
        });
    }
